...
# I libri hanno un titolo, un autore, un genere e un numero di copie disponibili.
# Gli utenti possono prendere in prestito un libro se ci sono copie libere; quando le copie sono esaurite, il prestito non è possibile.
